                            ...
                            <table class="table table-striped" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Telephone</th>
                                        <th>Apply Date</th>
                                        <th class="text-center">CV Download</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="name">{{$item->telephone }}</td>
                                        <td class="name">{{$item->created_at}}</td> 
                                    <td class="text-center">
                                        <a href="{{url('download_dock',[$item->Aid])}}"><span class="badge bg-success"><i class="bi bi-pencil-square"></i></span></a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{url('delete_apply_job',[$item->Aid])}}" onclick="return confirm('Are you sure?')"><span class="badge bg-danger"><i class="bi bi-trash"></i></span></a>
                                    </td>
